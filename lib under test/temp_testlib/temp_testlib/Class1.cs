...
namespace VLClibDM
{
    ...
    public class VlcMediaPlayer : IDisposable
    {
        ...
        public int currentSubtitleID
        {
            get
            {
                return LibVlc.libvlc_video_get_spu(Handle);
        ...
        public bool isScrambled
        {
            get
            {
                int i = LibVlc.libvlc_media_player_program_scrambled(Handle);
                if (i == 1)
                {
                    return true;
                }
        ...
        public int EnableAdjustOptions
        {
            ...
            set
            {
                ...
                LibVlc.libvlc_video_set_adjust_int(Handle, libvlc_video_adjust_option_t.libvlc_adjust_Enable, value);
